"""
Portfolio Manager for AutoInvestor
...
class PortfolioManager:
    """
    Manages portfolio state for AutoInvestor
...
if __name__ == "__main__":
    ...
    # Buy some AAPL
    print("\n2. Buying 100 AAPL @ $180...")
    result = pm.execute_trade("AAPL", "BUY", 100, 180.0)
    print(json.dumps(result, indent=2))

    # Buy some NVDA
    print("\n3. Buying 50 NVDA @ $500...")
    result = pm.execute_trade("NVDA", "BUY", 50, 500.0)
    print(json.dumps(result, indent=2))

    # Update prices
    print("\n4. Updating prices (AAPL up to $190, NVDA up to $550)...")
    pm.update_prices({"AAPL": 190.0, "NVDA": 550.0})
    print(json.dumps(pm.get_portfolio_summary(), indent=2))

    # Sell some AAPL
    print("\n5. Selling 50 AAPL @ $190...")
    result = pm.execute_trade("AAPL", "SELL", 50, 190.0)
    print(json.dumps(result, indent=2))
    ...
    print("\n7. Trade History:")
    print(json.dumps(pm.get_trade_history(), indent=2))
