"""
Strategy Trigger - Python-to-Claude Strategic Reviews
...
try:
    ...
    print("WARNING: anthropic package not installed. Install with: pip install anthropic>=0.39.0")
...
def test_strategy_trigger():
    """Test the strategy trigger with a sample review"""
    print("Testing Strategy Trigger...")
    print("=" * 70)
